...
class mob:
    ...
    def __init__(self, posicionY, bambu, posicionEnbambu, velocidad):
        ...
        self.velocidad = velocidad                 #Que tanto se mueve por fraccion de tiempo, asi se pueden hacer enemigos con diferentes velocidades #y replicar el movimiento de ataque del panda hacia abajo, que lo hace descender mas rapido
